...
public class IdentificationTable implements Cloneable{// a table of declarations
	...
	public IdentificationTable(HashMap<String, Declaration> levelTable) {
		culumativeIdTable = new ArrayList<HashMap<String, Declaration>>();
		culumativeIdTable.add(topLevelMap = levelTable);
	}
	...
	public void openScope (HashMap<String, Declaration> levelTable) { //raise level by one
	...
	public int enterDecl(Declaration attr){
		return enter(attr.id.spelling, attr);
	}
	...
	private int append(HashMap<String, Declaration> levelTable){ //should append 
		// if empty, replace the empty 
	...
	public int setEmptyTop(HashMap<String, Declaration> levelTable){
		if (getMapAtLevel(getTopLevel()).size() != 0){
