...
public class Echo {
	...
	public static void main(String[] args) throws IOException{
		...
		String requestURL = new String(tokensTank[1]);
		String interpretURL = "." + requestURL;
		...
		if(!ext.contentEquals("txt") 
				...
				&& !ext.contentEquals("html")
				){
			System.out.println("501 Not Implemented: " + requestURL);
			return;
		}

		File file_linked = new File(interpretURL);

		try{
			Scanner inputStream = new Scanner(file_linked);
