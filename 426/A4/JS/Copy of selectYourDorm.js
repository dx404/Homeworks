...
$(document).ready(function(){
	...
	for (var k in Dorm.all){
		$('table.preSelect').append(renderPreSelectDormRow(k));
...
//		var commonID = $(this).parent().attr('id').split('-');
//		var targetToSort = $('tbody.' + commonID);
//		var sortCriteria = function(){};
//		if ($(this).attr('value') == 'a2z'){
//			sortCriteria = function(tr0, tr1){return tr0.id > tr1.id;};
//		}
...
//		}
//		targetToSort.html(
//			$('tr', targetToSort).sort(sortCriteria)
//		);
//	});
	$('select.sort option').on('click', function(){
		var commonID = $(this).parent().attr('id').split('-');
		...
		var sortCriteria = function(){};
		targetToSort.html(
			$('tr', targetToSort).sort(function(tr0, tr1){return tr0.id > tr1.id;})
		);
	});
