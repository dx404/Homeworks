...
<html>
<head>
<title>Find My Roommate - Main Page</title>
<base href="." target="_blank">
<meta charset="utf-8">
<script src="JS/jquery-1.8.2.js"></script>
<script src="JS/sampleSnippet.js"></script>
					...
					<table>
						<tbody>
							<tr>
								<td>
									<div>
										Gender: <label>Male <input type="radio" name="gender"
											value="M">
										</label> <label>Female<input type="radio" name="gender"
											value="F" checked>
										</label>
									</div>
								</td>
							...
							<tr>
								<td colspan="2">
									<div>
										Year: <label>Freshman<input type="radio" name="year"
											value="FR">
										</label> <label>Sophomore<input type="radio" name="year"
											value="SO" checked>
										</label> <label>Junior<input type="radio" name="year"
											value="JR">
										</label> <label>Senior<input type="radio" name="year"
											value="SR">
										</label> <label>Graduate Students<input type="radio"
											name="year" value="GR">
										</label>
									</div>
								</td>
