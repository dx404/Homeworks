 ...
 */
 ...
 var User = function (username, first, last, 
		 			  gender, dob, year, major, 
		 			  music, visitor, sleep, wake, clean, 
		 			  intro,photo) {
 	this.first = first;
 	this.last = last;
...
// }
	 ...
	 User.prototype.comparePreference = function (searchmusic, searchvisitor,searchsleep,searchwake,searchclean){
		var returnScore=0;
