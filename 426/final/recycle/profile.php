...
<body>
	...
	<div class="profile-page content">
		...
		<form class="main" action="PHPScripts/userRequests.php" method="post">
			<div id="info">
						...
						<table>
							<tr>
								...
								<td><input type="text" name="uid"> 
									...
									<button type="button"> Is available?</button>
								</td>
							</tr>
							<tr>
								<td>First Name</td>
					...
					<fieldset class="simple-input-block">
						...
						<table>
							<tr>
								<td>
									<figure>
										<img src="image/users/default/littleEngineerAvatar.jpg"
				...
				<fieldset class="simple-input-block">
					...
					<table>
						<tr>
							...
							<td><input type="password" name="oldpass"><span class="required">*</span></td>
						</tr>
						<tr>
							<td>New Password</td>
